...
func TestSet1622(t *testing.T) {
    ...
    ctx.SetVar("v_peer2", ctx.Must(utest.[ERROR] function u_get_udpn_region_resource is not implemented(ctx.GetVar("Region"))))
...
func testSet1622CreateVPC02(ctx *utest.TestContext) {
    ...
    ctx.NoError(utest.SetReqValue(req, "Region", "^[v_peer2]"))
    ctx.NoError(utest.SetReqValue(req, "ProjectId", ctx.GetVar("project_id")))
    ctx.NoError(utest.SetReqValue(req, "Name", "VPC_TEST"))
    ctx.NoError(utest.SetReqValue(req, "Network", "192.168.0.0/16"))
...
func testSet1622GetUDPNPrice03(ctx *utest.TestContext) {
    ...
    ctx.NoError(utest.SetReqValue(req, "Peer2", "^[v_peer2]"))
...
func testSet1622DescribeUDPN05(ctx *utest.TestContext) {
    ...
    ctx.NoError(utest.SetReqValue(req, "UDPNId", "^UdpnId"))
...
func testSet1622CreateVPCIntercom06(ctx *utest.TestContext) {
    ...
    ctx.NoError(utest.SetReqValue(req, "DstRegion", ctx.Must(utest.[ERROR] function u_get_not_equal is not implemented(ctx.GetVar("Region"), ctx.GetVar("peer_1"), ctx.GetVar("peer_2")))))
    ctx.NoError(utest.SetReqValue(req, "DstProjectId", ctx.GetVar("project_id")))
...
func testSet1622DeleteVPCIntercom09(ctx *utest.TestContext) {
    ...
    ctx.NoError(utest.SetReqValue(req, "VPCId", ctx.GetVar("src_vpc_id")))
    ctx.NoError(utest.SetReqValue(req, "DstVPCId", ctx.GetVar("dest_vpc_id")))
    ctx.NoError(utest.SetReqValue(req, "DstRegion", "^[v_peer2]"))
    ctx.NoError(utest.SetReqValue(req, "DstProjectId", ctx.GetVar("project_id")))
